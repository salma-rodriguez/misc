...
\NewEntry{phone}{(H) +1 (305) 705 7708\ \ $\cdotp$\ \ (M) +1 (786) 486 4059} % Phone number(s)
...
\NewEntry{4/13--pres.}{Engineer, \textsc{IBM} --- Poughkeepsie}

\Description{\MarginText{International Business Machines}Developing and testing firmware changes on the IBM Mainframe, with focus on maintaining the guaranteed level of RAS and security in the processor resource system management facility.} % \\ Reference: John \textsc{McDonald}\ \ $\cdotp$\ \ +1 (000) 111 1111\ \ $\cdotp$\ \ \href{mailto:john@lehman.com}{john@lehman.com}}

\vspace{-0.5em} % Negative vertical space to counteract the vertical space between every \Description command

\Description{Pioneering the first IBM Mainframe z/OS cloud services using a fully REST compliant API, working in a team to research and develop automation workflows for the encryption/decryption cloud service, MQ as a service, and future web services.}
...
\NewEntry{9/12--12/12}{Research Assistant, \textsc{FIU}  --- Miami}

\Description{\MarginText{SCIS, Florida Int'l University}Researched proof of concept prototypes to improve reliability on spinning disk storage servers, using write-back persistence and replication policies on client flash.}
...
\NewEntry{4/11--9/11}{Research Assistant, \textsc{FIU} --- Miami}
...
\NewEntry{8/09--12/12}{Florida International University --- Miami}
...
\spacedlowsmallcaps{Certifications}\vspace{1em}

\NewEntry{11/14--pres.}{Johns Hopkins University --- Coursera}

\Description{\MarginText{Data Science Specialization}Taking nine courses covering various topics in data science to be completed by June 20th, 2015, plus a real world capstone project (date: TBD).}

\NewEntry{9/14--11/14}{Georgia Institute of Technology --- Coursera}
...
\Description{\MarginText{Interests}Programming\ \ $\cdotp$\ \ Writing\ \ $\cdotp$\ \ Piano\ \ $\cdotp$\ \ Mathematics\ \ $\cdotp$\ \  Public Speaking\ \ $\cdotp$\ \ Presenting}
