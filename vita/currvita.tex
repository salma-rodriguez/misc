...
\NewEntry{2/15--pres.}{University of Washington --- Coursera}
...
\Description{\MarginText{International Business Machines}Developing and testing firmware changes on the IBM Mainframe, with focus on maintaining the guaranteed level of RAS and security in the processor resource system manager facility.} % \\ Reference: John \textsc{McDonald}\ \ $\cdotp$\ \ +1 (000) 111 1111\ \ $\cdotp$\ \ \href{mailto:john@lehman.com}{john@lehman.com}}
